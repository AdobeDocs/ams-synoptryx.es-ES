...
Gracias por contribuir con la documentación de Adobe Experience Manager Cloud Service. El equipo de documentación agradece las contribuciones de contenido de toda la comunidad de lectores y de otros empleados de Adobe.
...
Puede contribuir fácilmente de dos maneras:
...
Las incidencias permiten describir fácilmente su idea para mejorar los documentos y un miembro del equipo de documentación de AEM puede revisarla. Simplemente haga clic en **[!UICONTROL Registrar un problema]** en la parte superior del panel de navegación derecho en cualquier página para crear un problema.

### Crear una solicitud de extracción {#create-a-pull-request}

Si ve un problema y sabe exactamente cómo solucionarlo, plantéese crear una solicitud de extracción. Las solicitudes de extracción le permiten realizar sus propios cambios en la documentación, que luego son revisados para su inclusión por un miembro del equipo de documentación de AEM. Simplemente haga clic en el vínculo **[!UICONTROL Editar esta página]** en la parte superior del panel de navegación derecho en cualquier página para realizar los cambios sugeridos y crear la solicitud de extracción.

Todas las solicitudes de extracción deben ir acompañadas por un [contrato de licencia de colaborador o CLA](https://opensource.adobe.com/cla.html) firmado. Esto otorga permiso a Adobe para redistribuir las contribuciones como parte del proyecto. Solo tiene que enviar un contrato de licencia de colaborador de Adobe, por lo que, si ha enviado uno anteriormente, ya está listo para comenzar.
