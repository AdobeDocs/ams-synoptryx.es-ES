---
source-git-commit: ba0ac46430310820cd9888cf6c48e04bc99ec4f1
workflow-type: tm+mt
...
Con el fin de fomentar un entorno abierto y acogedor, el equipo de documentación de Adobe, como colaboradores y administradores, se compromete a hacer de la participación en este proyecto y comunidad una experiencia libre de acoso para todos, independientemente de la edad, dimensión corporal, discapacidad, etnia, identidad y expresión de género, nivel de experiencia, nacionalidad, apariencia personal, raza, religión o identidad y orientación sexual.
...
Este Código de conducta es una adaptación del [Pacto de los colaboradores](https://www.contributor-covenant.org/), versión 1.4, disponible en [Código de conducta del Pacto de los colaboradores](https://www.contributor-covenant.org/version/1/4/code-of-conduct/).
